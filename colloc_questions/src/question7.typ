...
$
"ACF"(k) = rho(y_t, space y_(t-k)) = ("cov"(y_t, space y_(t-k))) / sqrt(sigma(y_t) sigma(y_(t-k))) approx (sum^T_(t=k)(y_t-overline(y))(y_(t-k)-overline(y))) / (sum_(t=1)^T (y_t - overline(y))),
$
