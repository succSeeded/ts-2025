...
#h(1.25em) 6.2. Estimate the variance of cluster $C_1$. If $"Var"(C_1) < epsilon_1 -> "goto 7"$, if $"IQR"(C_1) < epsilon_2 -> "goto 7"$

#h(1.25em) 6.3. Identify the point as non-predictable and nove to the next point.
